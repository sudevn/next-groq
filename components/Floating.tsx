const Floating = () => {
  return (
    ...
    >
      <button
        type="button"
        className="px-6 backdrop-blur hover:px-8 py-2 rounded-full relative dark:bg-neutral-700/50 dark:text-white text-xs md:text-sm hover:shadow-lg hover:shadow-orange-600/[0.2] transition-all duration-300 border border-stone-300 dark:border-neutral-700"
      >
