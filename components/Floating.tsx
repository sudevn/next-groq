const Floating = () => {
  return (
    ...
    >
      <button
        type="button"
        className="px-6 hover:px-8 py-2 rounded-full relative bg-neutral-700/50 text-white text-xs md:text-sm hover:shadow-lg hover:shadow-orange-600/[0.2] transition-all duration-300 border border-neutral-700"
      >
